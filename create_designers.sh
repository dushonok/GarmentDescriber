...
function create {
  OUT="$(curl --user 3c9830eea3fa5afd760748ac941feb1a0b97c890f94734c6b16b7d036e816e4d:apikey --data '{"name": "'"$1"'"}' 'https://api.merchantos.com/API/Account/71231/Vendor.json')"
